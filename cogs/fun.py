...
class Fun:
    ...
    async def awesome(self, ctx):
        ...
        query = 'SELECT is_awesome FROM guild_configs WHERE guild_id = $1;'
    ...
    async def awesome_on(self, ctx):
        ...
        query = """
    INSERT INTO guild_configs (guild_id, is_awesome) VALUES ($1, TRUE)
    ...
    async def awesome_off(self, ctx):
        ...
        query = """
    INSERT INTO guild_configs (guild_id, is_awesome) VALUES ($1, FALSE)
    ON CONFLICT (guild_id)
      DO UPDATE SET
        is_awesome = EXCLUDED.is_awesome;"""
